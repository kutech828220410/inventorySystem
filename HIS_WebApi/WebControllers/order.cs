...
namespace HIS_WebApi
{
    ...
    public class orderController : Controller
    {
        ...
        private string CheckCreatTable(ServerSettingClass serverSettingClass)
        {
            ...
            table.AddColumnList("藥品碼", Table.StringType.VARCHAR, 10, Table.IndexType.INDEX);
            table.AddColumnList("藥品名稱", Table.StringType.VARCHAR, 200, Table.IndexType.None);
            table.AddColumnList("領藥號", Table.StringType.VARCHAR, 15, Table.IndexType.INDEX);
            ...
            table.AddColumnList("病房", Table.StringType.VARCHAR, 10, Table.IndexType.INDEX);
            ...
            table.AddColumnList("開方日期", Table.DateType.DATETIME, 15, Table.IndexType.INDEX);
            ...
            table.AddColumnList("產出時間", Table.DateType.DATETIME, 15, Table.IndexType.INDEX);
