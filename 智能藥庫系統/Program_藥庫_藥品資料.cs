...
namespace 智能藥庫系統
{
    public partial class Form1 : Form
    {
        ...
        private void sub_Program_藥庫_藥品資料_Init()
        {
            ...
            {
                this.sqL_DataGridView_藥庫_藥品資料.SQL_CheckAllColumnName(true);
            }
        ...
        private void Function_藥庫_藥品資料_檢查表格()
        {
            ...
            Parallel.ForEach(list_雲端藥檔, value =>
            {
                ...
                list_藥品資料_buf = list_藥品資料.GetRows((int)enum_藥庫_藥品資料.藥品碼, value[(int)enum_藥品資料_資料維護_雲端藥檔.藥品碼].ObjectToString());
                object[] src_value = LINQ.CopyRow(value, new enum_藥品資料_資料維護_雲端藥檔(), new enum_藥庫_藥品資料());
            ...
            {
                List<object[]> list_雲端藥檔_buf = list_雲端藥檔.GetRows((int)enum_藥品資料_資料維護_雲端藥檔.藥品碼, value[(int)enum_藥庫_藥品資料.藥品碼].ObjectToString());
