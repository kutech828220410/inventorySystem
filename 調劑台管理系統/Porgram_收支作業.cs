...
namespace 調劑台管理系統
{
    public partial class Form1 : Form
    {
        ...
        void sub_Program_收支作業_單品入庫_狀態更新()
        {
            ...
            if (cnt_Program_收支作業_單品入庫_狀態更新 == 3) cnt_Program_收支作業_單品入庫_狀態更新 = 65500;
        ...
        {
            Dialog_收支原因設定 dialog_收支原因設定 = new Dialog_收支原因設定($"{dBConfigClass.Api_URL}/api/IncomeReasons");
        ...
        private void PlC_RJ_Button_收支作業_選擇儲位_MouseDownEvent(MouseEventArgs mevent)
        {
            ...
            {
                Dialog_收支原因選擇 dialog_收支原因選擇 = new Dialog_收支原因選擇($"{dBConfigClass.Api_URL}/api/IncomeReasons");
            ...
            string 效期 = 輸入效期;
            string 批號 = 輸入批號;
            this.Function_取藥堆疊資料_新增母資料(GUID, 調劑台名稱, 動作, 藥品碼, 藥品名稱, 藥袋序號, 單位, 病歷號, 病人姓名, 開方時間, IP, 操作人, 顏色, 總異動量, 效期, 批號, 收支原因);
