...
namespace HIS_DB_Lib
{
    ...
    public class ShiftConfigClass
    {
        ...
        static public List<ShiftConfigClass> get_all(string API_Server, string ServerName, string ServerType)
        {
            List<ShiftConfigClass> medShiftConfigClasses = new List<ShiftConfigClass>();
            ...
            medShiftConfigClasses = returnData.Data.ObjToClass<List<ShiftConfigClass>>();
            Console.WriteLine($"{returnData}");
            return medShiftConfigClasses;
        }
        static public List<ShiftConfigClass> get_datas_all(string API_Server, List<string> serverNames, List<string> serverTypes)
        {
            ...
            List<ShiftConfigClass> medShiftConfigClasses = returnData_out.Data.ObjToClass<List<ShiftConfigClass>>();
            return medShiftConfigClasses;
        }
    }


    public class ShiftListClass
    {
        [JsonPropertyName("GUID")]
        public string GUID { get; set; }
        [JsonPropertyName("CODE")]
