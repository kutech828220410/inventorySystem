...
namespace ServerSettingForm
{
    public partial class Dialog_癌症備藥機 : Form
    {
        ...
        private void Function_Add(string Name)
        {
            ...
            serverSettingClasses = serverSettingClasses.MyFind(Name, enum_ServerSetting_Type.癌症備藥機);
            Panel_SQLContent.SetValue(this.FindForm(), Name, enum_ServerSetting_Type.癌症備藥機);
            Panel_SQLContent.SaveAll(this.FindForm(), ref serverSettingClasses);
            Panel_API_URL.SetValue(this.FindForm(), Name, enum_ServerSetting_Type.癌症備藥機);
            Panel_API_URL.SaveAll(this.FindForm(), ref serverSettingClasses);
            Panel_CheckBox.SetValue(this.FindForm(), enum_ServerSetting_Type.癌症備藥機);
        ...
        private void Button_讀取_Click(object sender, EventArgs e)
        {
            ...
            returnData returnData = json_result.JsonDeserializet<returnData>();
            List<ServerSettingClass> serverSettingClasses = returnData.Data.ObjToListClass<ServerSettingClass>();
            serverSettingClasses = serverSettingClasses.MyFind(enum_ServerSetting_Type.癌症備藥機);
            Panel_SQLContent.SetValue(this.FindForm(), comboBox_名稱.Text, enum_ServerSetting_Type.癌症備藥機);
            Panel_SQLContent.LoadAll(this.FindForm(), serverSettingClasses);

            Panel_API_URL.SetValue(this.FindForm(), comboBox_名稱.Text, enum_ServerSetting_Type.癌症備藥機);
            ...
            ServerSettingClass serverSettingClass = serverSettingClasses.myFind(comboBox_名稱.Text, enum_ServerSetting_Type.癌症備藥機.GetEnumName(), "一般資料");
        ...
        private void Button_刪除_Click(object sender, EventArgs e)
        {
            ...
            serverSettingClasses = (from value in serverSettingClasses
                                    where value.類別 == enum_ServerSetting_Type.癌症備藥機.GetEnumName()
        ...
        private void Button_測試_Click(object sender, EventArgs e)
        {
            ...
            returnData returnData = json_result.JsonDeserializet<returnData>();
            List<ServerSettingClass> serverSettingClasses = returnData.Data.ObjToListClass<ServerSettingClass>();
            serverSettingClasses = ServerSettingClassMethod.MyFind(serverSettingClasses, enum_ServerSetting_Type.癌症備藥機);
            comboBox_名稱.Items.Clear();
