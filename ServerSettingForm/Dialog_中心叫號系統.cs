...
{
    public partial class Dialog_中心叫號系統 : Form
    {
        ...
        public Dialog_中心叫號系統()
        {
            InitializeComponent();
            this.Load += Dialog_中心叫號系統_Load;
        }
        ...
        #region Event
        private void Dialog_中心叫號系統_FormClosing(object sender, FormClosingEventArgs e)
        {

        }
        private void Dialog_中心叫號系統_Load(object sender, EventArgs e)
        {
        ...
        {
            Dialog_新增 dialog_新增 = new Dialog_新增("請輸入中心叫號系統名稱...");
